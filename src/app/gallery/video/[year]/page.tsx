    ...
    return (
      <main className="min-h-screen bg-background px-4 py-10">
        <section className="mx-auto max-w-7xl rounded-2xl bg-bg-primary p-8 text-center shadow-sm">
          <p className="text-sm font-bold text-secondary">Loading videos...</p>
        </section>
      </main>
    );
  }
    ...
    return (
      <main className="min-h-screen bg-background px-4 py-10">
        <section className="mx-auto max-w-[900px] rounded-2xl bg-bg-primary p-8 text-center shadow-sm">
          <h1 className="text-3xl font-black text-primary">Video Gallery Not Found</h1>
          <p className="mt-3 text-secondary">This year video gallery does not exist.</p>
    ...
    <main className="min-h-screen bg-background px-3 py-8 sm:px-4 sm:py-10">
      ...
      {activeVideo && (
        <section className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 px-3 py-10">
          ...
          <div className="relative z-10 w-full max-w-5xl overflow-hidden rounded-2xl bg-bg-primary shadow-2xl">
            <div className="flex items-center justify-between gap-4 border-b border-secondary p-4">
              ...
              <button
                type="button"
                onClick={closeVideo}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-inverse transition-all duration-300 hover:scale-110 hover:bg-primary/90"
            ...
            <div className="flex flex-col gap-3 p-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                ...
                className="inline-flex shrink-0 rounded-lg bg-primary px-5 py-2 text-sm font-bold text-inverse transition-all duration-300 hover:bg-primary/90"
              >
                Open YouTube
              </a>
            </div>
