    ...
    <main className="flex min-h-[70vh] items-center justify-center bg-white px-4 py-10">
      <section className="w-full max-w-3xl rounded-3xl bg-secondary px-6 py-10 text-center shadow-sm sm:px-10 lg:px-14">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/"
            className="rounded-lg bg-primary px-6 py-3 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-primary/90 hover:shadow-md"
          >
            Back to Home
          </Link>
          ...
          <Link
            href="/contact"
            className="rounded-lg border border-primary bg-white px-6 py-3 text-sm font-bold text-primary transition-all duration-300 hover:-translate-y-1 hover:bg-primary hover:text-white hover:shadow-md"
          >
            Contact Support
          </Link>
        </div>
