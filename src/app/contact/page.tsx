      ...
      <section className="mx-auto my-10 max-w-[1260px] px-4">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:min-h-48">
          {contactInfo.map((item, index) => (
            ...
            >
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[#E2EDF7] transition-all duration-500 group-hover:scale-110 group-hover:bg-red-50">
                {item.icon}
              </div>

              <p className="text-lg font-bold text-[#1267B1] transition-colors duration-300 group-hover:text-[#FF0000]">
                {item.title}
              </p>
          ...
          <form className="flex flex-col space-y-6 lg:space-y-10">
            <div className="flex flex-col gap-6 lg:flex-row lg:gap-10">
              <input
                ...
                className="w-full rounded-xl bg-[#ECECEC] p-4 text-sm outline-none transition-all duration-300 placeholder:text-gray-500 focus:bg-[#E2EDF7] focus:ring-2 focus:ring-[#FF0000]/40 lg:w-1/2"
              />
            ...
            <textarea
              ...
              placeholder="Message"
              name="message"
              className="w-full resize-none rounded-xl bg-[#ECECEC] p-4 text-sm outline-none transition-all duration-300 placeholder:text-gray-500 focus:bg-[#E2EDF7] focus:ring-2 focus:ring-[#FF0000]/40"
            />

            <button
              type="submit"
              className="mx-auto w-full rounded-xl bg-[#FF0000] px-8 py-3 font-bold text-white shadow-md transition-all duration-300 hover:-translate-y-1 hover:bg-red-700 hover:shadow-xl active:scale-95 lg:w-44"
            >
              Submit
            </button>
          </form>
