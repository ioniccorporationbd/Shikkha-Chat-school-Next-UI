      ...
      <div className="rounded-2xl bg-white p-5 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-7 lg:p-8">
        ...
        <div className="mb-10 grid grid-cols-1 gap-5 md:grid-cols-3">
          {visionCards.map((item) => (
            <div
              key={item.id}
              className="group rounded-2xl bg-secondary p-6 text-center transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-xl"
            >
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-white text-xl font-bold text-primary transition-all duration-500 group-hover:bg-primary group-hover:text-white group-hover:scale-110">
                {item.id}
              </div>

              <h2 className="text-lg font-bold text-black transition-colors duration-300 group-hover:text-primary">
                {item.title}
              </h2>
            ...
            {objectives.map((item) => (
              ...
              >
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-secondary text-sm font-bold text-primary transition-all duration-500 group-hover:bg-primary group-hover:text-white">
                    {item.id}
                  </div>
        ...
        {/* Bottom Note */}
        <div className="mt-10 rounded-2xl bg-secondary p-5 text-center transition-all duration-500 hover:-translate-y-1 hover:bg-white hover:shadow-lg">
