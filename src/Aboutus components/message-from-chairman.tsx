...
const chairmanInfo: ChairmanInfo = {
  name: "Tanvir Ahmed",
  position: "Chairman",
  institution: "Viqarunnisa Noon School & College",
  image: "/assets/oddhayan imagea/Tanvir Ahmed.jpeg",
  message:
...
const Message_From_Chairman = () => {
  return (
    <section className="mx-2 lg:mx-0">
      <div className="rounded-2xl bg-white p-4 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-6 lg:p-8">
        <div className="flex justify-center">
          <div className="group relative h-[300px] w-full max-w-[430px] overflow-hidden rounded-xl bg-[#E2EDF7] shadow-sm sm:h-[360px] lg:h-[430px]">
            <Image
              src={chairmanInfo.image}
        ...
        <p className="py-5 text-justify text-sm leading-7 text-gray-700 sm:text-base lg:leading-8">
          {chairmanInfo.message}
        </p>

        <div className="border-l-4 border-[#FF0000] bg-[#E2EDF7]/60 px-4 py-3">
          <p className="text-lg font-bold text-black">{chairmanInfo.name}</p>
          <p className="font-semibold text-[#FF0000]">
            {chairmanInfo.position}
          </p>
          <p className="font-medium text-gray-700">
            {chairmanInfo.institution}
          </p>
        </div>
      </div>
    </section>
