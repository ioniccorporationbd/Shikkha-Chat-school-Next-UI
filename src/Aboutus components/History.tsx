    ...
    <section className="mx-2 lg:mx-0">
      <div className="rounded-2xl bg-white p-5 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-7 lg:p-8">
        ...
        <div className="mb-8 text-center lg:text-left">
          ...
          <div className="mx-auto mt-3 h-[3px] w-24 rounded-full bg-primary lg:mx-0" />
        ...
        <div className="mb-10 grid grid-cols-2 gap-4 lg:grid-cols-4">
          {summaryItems.map((item) => (
            <div
              key={item.label}
              className="group rounded-2xl bg-secondary p-5 text-center transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-xl"
            >
              <p className="text-2xl font-bold text-primary transition-transform duration-500 group-hover:scale-110 sm:text-3xl">
                {item.value}
              </p>
        ...
        <div className="relative space-y-7">
          <div className="absolute bottom-0 left-5 top-0 hidden w-[2px] bg-secondary sm:block" />

          {historySections.map((section) => (
            <article
              key={section.id}
              className="group relative rounded-2xl border border-secondary bg-white p-5 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl sm:ml-12 sm:p-6"
            >
              <div className="absolute -left-[3.25rem] top-6 hidden h-10 w-10 items-center justify-center rounded-full bg-primary text-sm font-bold text-white shadow-md transition-all duration-500 group-hover:scale-110 sm:flex">
                {section.id}
              </div>

              <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <h2 className="text-lg font-bold text-black transition-colors duration-300 group-hover:text-primary sm:text-xl">
                  {section.title}
                </h2>

                <span className="w-fit rounded-full bg-secondary px-4 py-1 text-sm font-bold text-primary transition-all duration-300 group-hover:bg-primary group-hover:text-white">
                  {section.year}
                </span>
              </div>
        ...
        {/* Final Note */}
        <div className="mt-10 rounded-2xl border-l-4 border-primary bg-secondary/70 p-5 transition-all duration-500 hover:bg-secondary hover:shadow-md">
