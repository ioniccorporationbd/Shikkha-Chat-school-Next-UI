  ...
  return (
    <section className="mx-2 lg:mx-0">
      <div className="rounded-2xl bg-white p-5 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-7 lg:p-8">
        ...
        {/* Vision Box */}
        <div className="mb-10 rounded-2xl bg-secondary p-5 transition-all duration-500 hover:-translate-y-1 hover:shadow-md sm:p-6">
          <h2 className="text-xl font-bold text-primary">Core Vision</h2>
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {planCards.map((item) => (
            ...
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-secondary text-lg font-bold text-primary transition-all duration-500 group-hover:bg-primary group-hover:text-white">
                {item.id}
              </div>
        ...
        <div className="mt-12">
          ...
          <div className="space-y-5">
            {phases.map((phase) => (
              <div
                key={phase.id}
                className="group flex flex-col gap-4 rounded-2xl bg-secondary p-5 transition-all duration-500 hover:-translate-y-1 hover:bg-white hover:shadow-lg sm:flex-row sm:items-start"
              >
                <div className="shrink-0 rounded-xl bg-primary px-5 py-3 text-center font-bold text-white shadow-sm">
                  {phase.year}
                </div>
        ...
        {/* Final Statement */}
        <div className="mt-12 rounded-2xl border-l-4 border-primary bg-secondary/70 p-5">
          <h2 className="text-xl font-bold text-primary">Expected Outcome</h2>
