  ...
  return (
    <section className="mx-2 lg:mx-0">
      <div className="rounded-2xl bg-white p-5 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-7 lg:p-8">
        ...
        {/* Highlight Box */}
        <div className="mb-10 rounded-2xl border-l-4 border-primary bg-secondary/70 p-5 transition-all duration-500 hover:bg-secondary hover:shadow-md sm:p-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {infrastructureItems.map((item) => (
            <div
              key={item.id}
              className="group rounded-2xl border border-secondary bg-white p-5 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-primary/30 hover:shadow-xl"
            >
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-secondary text-lg font-bold text-primary transition-all duration-500 group-hover:scale-110 group-hover:bg-primary group-hover:text-white">
                {item.id}
              </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 xl:grid-cols-4">
            {facilities.map((facility) => (
              <div
                key={facility.id}
                className="group flex items-center gap-3 rounded-xl bg-secondary p-4 transition-all duration-500 hover:-translate-y-1 hover:bg-white hover:shadow-lg"
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-sm font-bold text-primary transition-all duration-500 group-hover:bg-primary group-hover:text-white">
                  ✓
                </div>

                <p className="text-sm font-semibold text-gray-700 transition-colors duration-300 group-hover:text-primary">
                  {facility.name}
                </p>
              </div>
            ))}
        ...
        {/* Development Focus */}
        <div className="mt-12 rounded-2xl bg-secondary p-5 transition-all duration-500 hover:-translate-y-1 hover:bg-white hover:shadow-lg sm:p-6">
          <h2 className="text-xl font-bold text-primary">
            Development Focus
          </h2>
