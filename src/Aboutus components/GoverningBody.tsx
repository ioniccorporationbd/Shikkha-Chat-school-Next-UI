...
const SocialButton = ({
  ...
  return (
    <button
      type="button"
      aria-label={label}
      className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-primary shadow-md transition-all duration-300 hover:-translate-y-1 hover:bg-primary hover:text-white"
    >
      {children}
    </button>
  );
...
const MemberCard = ({ member }: { member: Member }) => {
  return (
    <article className="group w-full max-w-[300px] overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-secondary transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:ring-primary/30">
      <div className="relative mx-auto mt-5 h-[310px] w-[230px] overflow-hidden rounded-2xl bg-secondary">
        <Image
          src={member.image}
          alt={member.name}
          fill
      ...
      <div className="px-5 pb-6 pt-4 text-center">
        <h3 className="text-base font-bold text-[#5358B2] transition-colors duration-300 group-hover:text-primary">
          {member.name}
        </h3>
        ...
        <div className="mx-auto mt-4 h-[3px] w-12 rounded-full bg-primary transition-all duration-500 group-hover:w-24" />
      </div>
    </article>
  );
};
    ...
    <section className="mx-2 lg:mx-0">
      <div className="overflow-hidden rounded-3xl bg-white p-5 shadow-sm transition-all duration-500 hover:shadow-lg sm:p-7 lg:p-8">
        ...
        <div className="relative mb-10 text-center lg:text-left">
          <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-secondary blur-2xl" />
          <div className="absolute -left-10 top-12 h-24 w-24 rounded-full bg-primary/10 blur-2xl" />

          <p className="relative text-sm font-semibold uppercase tracking-[0.25em] text-primary">
            Leadership Team
          </p>
          ...
          <div className="relative mx-auto mt-3 h-[3px] w-24 rounded-full bg-primary lg:mx-0" />
        ...
        <div className="mb-12 grid grid-cols-2 gap-4">
          {stats.map((item) => (
            ...
            >
              <p className="text-3xl font-bold text-primary transition-transform duration-500 group-hover:scale-110">
                {item.value}
              </p>
