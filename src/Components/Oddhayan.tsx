...
import oddhayan from "../../public/assets/oddhayan imagea/oddoyan.png";
import chairmanImage from "../../public/assets/oddhayan imagea/Tanvir Ahmed.jpeg";
import principalImage from "../../public/assets/oddhayan imagea/Mazeda Begum.png";
...
const SectionHeading = ({ title }: SectionHeadingProps) => {
  return (
    <div className="mb-5 text-center lg:text-left">
      <h2 className="text-xl font-bold text-[#FF0000] sm:text-2xl lg:text-3xl">
        {title}
      </h2>
...
const ProfileCard = ({ image, name, designation }: ProfileCardProps) => {
  return (
    <div className="group flex min-h-[300px] flex-col items-center justify-center rounded-2xl bg-white/95 p-5 text-center shadow-sm ring-1 ring-red-100 transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-xl hover:ring-red-200">
      ...
      <h3 className="text-base font-bold text-[#FF0000] transition-colors duration-300 sm:text-lg">
        {name}
      </h3>
      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto my-10 grid max-w-7xl grid-cols-1 gap-10 px-3 sm:px-5 lg:px-6 xl:grid-cols-2">
          ...
          <div className="rounded-2xl bg-white/80 p-3 backdrop-blur-sm transition-all duration-500 ease-out hover:bg-white sm:p-5 lg:p-6">
            ...
            <div className="mt-4">
              <p className="text-center text-base font-medium text-[#FF0000] transition-all duration-300 lg:text-left lg:text-lg">
                Tanvir Ahmed
              </p>
